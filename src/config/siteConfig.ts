...
export const siteConfig: SiteConfig = {
	...
	// 站点描述
	description:
		"L!!!!ght From Firefly。Firefly 是一款基于 Astro 框架和 Fuwari 模板开发的清新美观且现代化个人博客主题模板，专为技术爱好者和内容创作者设计。",
	...
	navbar: {
		...
		logo: {
			type: "image",
			value: "assets/images/papagan.png",
			alt: "🍀",
		},
		// 导航栏标题
		title: "耙耙柑",
	...
	analytics: {
		...
		umamiAnalytics: {
			// Umami Website ID
			websiteId: "27adcc6c-11e6-48bc-963f-a067dd6f9268",
			// Umami JS地址，支持使用自建
			scriptUrl: "https://umami.kejk.cn/script.js",
